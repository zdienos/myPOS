...
<div id="laporan">
    ...
    <table border="1" align="center" style="width:900px;margin-bottom:20px;">
        ...
        ?>
        <tr>
            <td colspan="8" ><b style="margin-left: 54%;">Biaya Expedisi</b></td>
        ...
        <tr>
            <td colspan="10" style="text-align:center;"><b>Total Biaya Expedisi</b></td>

            <td style="text-align:right;"><b><?php echo 'Rp '.number_format($b['total_expedisi']);?></b></td>
        </tr>
        <tr>
            <td colspan="10" style="text-align:center;"><b>Total Penjualan</b></td>
