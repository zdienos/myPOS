...
<?php } ?>
  ...
  <?php if($invoice[0]->expedisi != 0){ ?>
      <div id="bkpos_wrp" style="margin-top: 8px;">
          <span class="left"><a href="#" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#000; background-color:#adf442; border:2px solid #adf442; padding: 10px 0px; font-weight:bold;" id="print">Print</a></span>
      </div>
      <div id="bkpos_wrp" style="margin-top: 8px;">
        <span class="left"><a href="<?php echo base_url()."index.php/administrator/faktur/".$no_faktur?>" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#000; background-color:#FFA93C; border:2px solid #FFA93C; padding: 10px 0px; font-weight:bold;">Print Label Expedisi</a></span>
    </div>
  <?php }?>
    <div id="bkpos_wrp" style="margin-top: 8px;">
